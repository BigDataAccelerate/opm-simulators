...
namespace Opm
{
    ...
    struct FlowLinearSolverParameters
    {
        ...
        static void registerParameters()
        {
            ...
            EWOMS_REGISTER_PARAM(TypeTag, std::string, AcceleratorMode, "Choose a linear solver, usage: '--accelerator-mode=[none|cusparse|opencl|amgcl|rocalution|rocsparse|c]'");
