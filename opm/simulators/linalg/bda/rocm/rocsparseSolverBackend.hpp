...
/// This class implements a rocsparse-based ilu0|cpr-bicgstab solver on GPU
...
public:
    ...
    rocsparseSolverBackend(int linear_solver_verbosity, int maxit, double tolerance, unsigned int platformID, unsigned int deviceID, std::string linsolver);
