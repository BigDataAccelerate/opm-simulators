...
// /// This class implements a C-based CPR-bicgstab solver on CPU
// template <unsigned int block_size>
...
// public:
//     /// Construct a cSolver
//     /// \param[in] linear_solver_verbosity    verbosity of cSolver
//     /// \param[in] maxit                      maximum number of iterations for cSolver
//     /// \param[in] tolerance                  required relative tolerance for cSolver
//     cSolverBackend(int linear_solver_verbosity, int maxit, double tolerance);
// 
//     /// For the CPR coarse solver
//     // rocsparseSolverBackend(int linear_solver_verbosity, int maxit, double tolerance, ILUReorder opencl_ilu_reorder);
// 
//     /// Destroy a cSolver, and free memory
//     ~cSolverBackend();
// 
//     /// Solve linear system, A*x = b, matrix A must be in blocked-CSR format
//     /// \param[in] matrix         matrix A
