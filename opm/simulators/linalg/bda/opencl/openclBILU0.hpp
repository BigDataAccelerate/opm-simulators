...
#ifndef OPENCLBILU0_HPP
#define OPENCLBILU0_HPP
...
class openclBILU0 : public openclPreconditioner<block_size>
{
...
public:
    ...
    openclBILU0(bool opencl_ilu_parallel, int verbosity_);
