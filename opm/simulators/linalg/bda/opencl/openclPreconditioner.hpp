...
class openclPreconditioner : public Preconditioner<block_size>
{
...
public:
    ...
    static std::unique_ptr<openclPreconditioner<block_size>> create(PreconditionerType type, int verbosity, bool opencl_ilu_parallel);
