...
if(USE_BDA_BRIDGE)
  ...
  if(rocsparse_FOUND AND rocblas_FOUND)
    ...
    #set_source_files_properties(opm/simulators/linalg/bda/rocsparseWellContributions.cpp PROPERTIES LANGUAGE HIP) 
    #set(CMAKE_HIP_COMPILE_OBJECT ${HIP_CXX_COMPILER})
    #message ("CMAKE_HIP_COMPILE_OBJECT = " ${CMAKE_HIP_COMPILE_OBJECT})
  endif()
  if(CUDA_FOUND)
